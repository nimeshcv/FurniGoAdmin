...
<body>
        <div class="container bg-light">
            ...
            @endif
            <h1 class="display-3 text-center">Category </h1>
                ...
                <div class="col-lg-8 ">
                    <form action="/categorysave" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Category Name" aria-label="Username" aria-describedby="basic-addon1" name="cat_name">
                        ...
                        <div class="form-floating mt-4">
                            <textarea id="query" class="form-control" style="height: 180px;" placeholder="enter query" name="desc"></textarea>
